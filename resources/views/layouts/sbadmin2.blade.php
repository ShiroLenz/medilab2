            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ url('pasien/laporan/cetak',[]) }}" target="_blank">Laporan Pasien</a>
                        <a class="collapse-item" href="{{ url('dokter/laporan/cetak',[]) }}" target="_blank">Laporan Dokter</a>
                        <a class="collapse-item" href="{{ url('administrasi/laporan/cetak',[]) }}">Laporan Administrasi</a>
